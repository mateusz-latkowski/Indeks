...
public class RegistrationInfo extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText editTextPesel_ID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextPesel_ID = (EditText) findViewById(R.id.editTextPesel_ID);
    ...
    private void saveUserInformation() {
        ...
        String pesel_id = editTextPesel_ID.getText().toString().trim();
        String street = editTextStreet.getText().toString().trim();
        String city = editTextCity.getText().toString().trim();
        String phoneNumber = editTextPhoneNumber.getText().toString().trim();


        UserInformation userInformation = new UserInformation(name, surname, pesel_id, street, city, phoneNumber);

        databaseReference.child((pesel_id)).setValue(userInformation);

        Intent intent = new Intent(RegistrationInfo.this, UserProfil.class);
        intent.putExtra("id", pesel_id);
